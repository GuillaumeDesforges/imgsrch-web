...
class Engine(_object):
    ...
    def __init__(self, *args):
        this = _imgsrch.new_Engine(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this

    def train(self, path, kmeanstreeTrainingSampleSize):
        return _imgsrch.Engine_train(self, path, kmeanstreeTrainingSampleSize)

    def indexDirectory(self, path):
        return _imgsrch.Engine_indexDirectory(self, path)

    def computeLikelihoods(self, path):
        return _imgsrch.Engine_computeLikelihoods(self, path)

    def write(self, file):
        return _imgsrch.Engine_write(self, file)

    def read(self, file):
        return _imgsrch.Engine_read(self, file)
    __swig_destroy__ = _imgsrch.delete_Engine
    __del__ = lambda self: None
Engine_swigregister = _imgsrch.Engine_swigregister
